export PATH=/usr/local/bin:/usr/local/sbin:$HOME/Scripts:$HOME/local/node/bin:$PATH
export NODE_PATH=$HOME/local/lib/node:$HOME/local/node/lib/node_modules
export ISYNCD_PATH=$HOME/Projects/Insync

# aliases
alias ll='ls $LS_OPTIONS -lhF'
alias l='ls $LS_OPTIONS -lAhF'
alias pbg='pbpaste | gorgeous | cat'
alias ..='cd ..'
...
[[ -s "/Users/marksteve/.rvm/scripts/rvm" ]] && source "/Users/marksteve/.rvm/scripts/rvm"
